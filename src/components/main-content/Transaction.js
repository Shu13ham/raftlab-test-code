    ...
    <div className="row  flex items-center">
      <div className="customer w-1/3 flex items-center min-w-[90px] flex-row">
        ...
        <div className="customer-info">
          <p className="customer-name m-0  font-medium">
            {transaction.customerName}
          </p>
          <p className="customer-email text-grey-text m-0 text-xs">
      ...
      <div className="date min-w-[60px] w-1/6 font-medium text-sm">
        {transaction.date}
      </div>
      <div className="invoice min-w-[55px] w-1/6 font-medium text-sm">
        {transaction.invoice}
      </div>
