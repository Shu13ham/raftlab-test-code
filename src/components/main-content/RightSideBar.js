...
export default function RightSideBar(props) {
  ...
  return (
    <div className="right-sidebar w-1/4 min-w-[270px]">
      <p className="subhead text-primary font-medium m-0 text-sm">
        Premium Access
      </p>
      <p className="info w-48 font-medium m-0 text-3xl">
      ...
      <select
        name="The Professional Platform"
        id="professional-platform"
        className="text-grey-text"
      >
        <option value="prof-platform text-xs text-grey-text">
          The Professional Platform
        </option>
        <option value="unprof-platform">The UnProfessional Platform</option>
      </select>
      <button className="border-grey-lines text-primary w-full flex justify-between  font-semibold">
        <span>Upgrade Now</span>
        <FontAwesomeIcon icon={faArrowRight} color="#6c62dd" size="lg" />
      </button>
          ...
          <div className="upcoming-meetings-wrapper" key={i}>
            <div className="upcoming-meeting flex justify-start items-center">
              ...
              <div className="meetings">
                ...
                <span className="text-sm text-grey-text first">
                  <FontAwesomeIcon
                    icon={faVideo}
                    color="#999"
                    className="text-grey-text"
