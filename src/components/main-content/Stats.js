          ...
          <div className="stat  flex justify-center items-center" key={i}>
            ...
            <div className="info">
              ...
              <div className='amount-percent  flex justify-center items-center'>
                <span className='amount text-white font-semibold text-lg'>{stat.amount}</span>
                <span className='percent bg-white text-primary font-medium text-xs'>{stat.percent}</span>
              </div>
              <p className='previous-record text-white font-bold m-0 text-xs'><span className='text-xs text-grey-text  font-medium'>Previous Year </span>{stat.prevYear}</p>
            </div>
          </div>
        )
      })}
